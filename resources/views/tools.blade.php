...
<section class="row col-lg-12 col-md-12 col-sm-12 col-12 m-lg-0 m-md-0 m-sm-0 m-0 mt-lg-4 pb-lg-5 pb-md-5 pb-sm-5 pb-5 pt-lg-4 pt-md-4 pt-sm-4 pt-4">
    <div id="titulo" class="row col-lg-12 col-md-12 col-sm-12 col-12 m-lg-0 m-md-0 m-sm-0 m-0">
        <div id="aux" class="col-lg-4 col-md-4 m-lg-0 m-md-0 m-sm-0 m-0 d-none d-sm-block"></div>
          <h1 class="text-center col-lg-4 col-md-4 col-sm-6 col-5 m-lg-0 m-md-0 m-sm-0 m-0">Tools</h1>
    ...
    <div id="productos" class="row col-lg-12 col-md-12 col-sm-12 col-12 m-lg-0 m-md-0 m-sm-0 m-0 mt-lg-4 pb-lg-5 ps-lg-5 ps-md-5 ps-sm-4 ps-4 pb-md-5 pb-sm-5 pb-5 pt-lg-4 pt-md-4 pt-sm-4 pt-4">
          ...
          <!-- Carousel -->
            <div id="demo" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-item active">
                    <img src="imagenes/brocha_a1.png" alt="Los Angeles" class="d-block w-100">
                </div>
                <div class="carousel-item">
                    <img src="imagenes/brocha_a2.png" alt="Chicago" class="d-block w-100">
                </div>
                </div>
            ...
            <div id="infor" class="p-lg-2 p-md-2 p-sm-1 p-2">
                    <h6 class="text-start mt-lg-2 mt-md-2 pt-sm-1 pt-2">Brocha Doble Punta Para Rubor</h6>
                    <p class="text-start mt-lg-3 mt-md-3 pt-sm-2 pt-3">
                        Color: Dorado y blanco<br>
                        Marca: Iconic London<br>
                        Textura: Esponjoso doble fibra<br>
                        Contenido: 1 pz
                    </p>
                <p id="precio" class="text-start mt-lg-2 mt-md-2 pt-sm-2 pt-2">$170.00</p>
            </div>
        </article>
        ...
        <article class="col-lg-3 p-lg-3 pb-lg-0 ms-lg-5 me-lg-5 col-md-5 p-md-3 pb-md-0 ms-md-4 me-md-4 mb-md-5 col-sm-5 p-sm-3 pb-sm-0 ms-sm-4 me-sm-4 mb-sm-5 col-9 p-3 pb-0 ms-5 me-4 mb-5">
            ...
            <div id="demo2" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="imagenes/kitBrocha_a1.png" alt="Los Angeles" class="d-block w-100">
                </div>
                <div class="carousel-item">
                    <img src="imagenes/kitBrocha_a2.png" alt="Chicago" class="d-block w-100">
                </div>
                </div>
            ...
            <!--Texto-->
            <div id="infor" class="p-lg-2 p-md-2 p-sm-1 p-2">
                <h6 class="text-start mt-lg-2 mt-md-2 pt-sm-1 pt-2">Set De Brochas</h6>
                <p class="text-start mt-lg-3 mt-md-3 pt-sm-2 pt-3">
                    Color: Tonos oscuros<br>
                    Marca: Morphe<br>
                    Textura: Cerdas sinteticas<br>
                    Contenido: 8 pz
                </p>
                <p id="precio" class="text-start mt-lg-2 mt-md-2 pt-sm-2 pt-2">$2,160.00</p>
            </div>
        </article>
        ...
        <article class="col-lg-3 p-lg-3 pb-lg-0 ms-lg-5 me-lg-5 col-md-5 p-md-3 pb-md-0 ms-md-4 me-md-4 mb-md-5 col-sm-5 p-sm-3 pb-sm-0 ms-sm-4 me-sm-4 mb-sm-5 col-9 p-3 pb-0 ms-5 me-4 mb-5">
            ...
            <div id="demo3" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="imagenes/esponja_a1.png" alt="Los Angeles" class="d-block w-100">
                </div>
                <div class="carousel-item">
                    <img src="imagenes/esponja_a2.png" alt="Chicago" class="d-block w-100">
                </div>
                <div class="carousel-item">
                    <img src="imagenes/esponja_a3.png" alt="Chicago" class="d-block w-100">
                </div>
                </div>
                <!-- Left and right controls/icons -->
            ...
            <!--Texto-->
            <div id="infor" class="p-lg-2 p-md-2 p-sm-1 p-2">
                <h6 class="text-start mt-lg-2 mt-md-2 pt-sm-1 pt-2">Esponja Modeladora de Maquillaje</h6>
                <p class="text-start mt-lg-3 mt-md-3 pt-sm-2 pt-3">
                    Color: Blanco<br>
                    Marca: Morphe<br>
                    Textura: Suave<br>
                ...
                <p id="precio" class="text-start mt-lg-2 mt-md-2 pt-sm-2 pt-2">$275.00</p>
            </div>
        </article>
    </div> 
</section>
