...
<section class="row col-lg-12 col-md-12 col-sm-12 col-12 m-lg-0 m-md-0 m-sm-0 m-0 mt-lg-4 pb-lg-5 pb-md-5 pb-sm-5 pb-5 pt-lg-4 pt-md-4 pt-sm-4 pt-4">
    <div id="titulo" class="row col-lg-12 col-md-12 col-sm-12 col-12 m-lg-0 m-md-0 m-sm-0 m-0">
        ...
        <h1 class="text-center col-lg-4 col-md-4 col-sm-6 col-5 m-lg-0 m-md-0 m-sm-0 m-0">Labios</h1>
        ...
        <article class="col-lg-3 p-lg-3 pb-lg-0 ms-lg-5 me-lg-5 col-md-5 p-md-3 pb-md-0 ms-md-4 me-md-4 mb-md-5 col-sm-5 p-sm-3 pb-sm-0 ms-sm-4 me-sm-4 mb-sm-5 col-9 p-3 pb-0 ms-5 me-4 mb-5">
            ...
            <div id="demo" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="imagenes/tintaLabial_a1.png" alt="Los Angeles" class="d-block w-100">
                    </div>
                    <div class="carousel-item">
                        <img src="imagenes/tintaLabial_a2.png" alt="Chicago" class="d-block w-100">
                    </div>
                </div>
                ...
                <div id="infor" class="p-lg-2 p-md-2 p-sm-1 p-2">
                    <h6 class="text-start mt-lg-2 mt-md-2 pt-sm-1 pt-2">Dear Darling Tint</h6>
                    <p class="text-start mt-lg-3 mt-md-3 pt-sm-2 pt-3">
                        Color: Rojo vino<br>
                        Marca:Etude House<br>
                        Textura: Gel<br>
                        Contenido: 4.5 g
                    </p>
            ...
            <article class="col-lg-3 p-lg-3 pb-lg-0 ms-lg-5 me-lg-5 col-md-5 p-md-3 pb-md-0 ms-md-4 me-md-4 mb-md-5 col-sm-5 p-sm-3 pb-sm-0 ms-sm-4 me-sm-4 mb-sm-5 col-9 p-3 pb-0 ms-5 me-4 mb-5">
                ...
                <div id="demo2" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="imagenes/glossLabial_a1.png" alt="Los Angeles" class="d-block w-100">
                    </div>
                    <div class="carousel-item">
                        <img src="imagenes/glossLabial_a2.png" alt="Chicago" class="d-block w-100">
                    </div>
                    <div class="carousel-item">
                        <img src="imagenes/glossLabial_a3.png" alt="New York" class="d-block w-100">
                    </div>
                    </div>
                ...
                <!--Texto-->
                <div id="infor" class="p-lg-2 p-md-2 p-sm-1 p-2">
                    <h6 class="text-start mt-lg-2 mt-md-2 pt-sm-1 pt-2">Gloss brillante</h6>
                    <p class="text-start mt-lg-3 mt-md-3 pt-sm-2 pt-3">
                        Color: Durazno<br>
                        Marca: New Standards<br>
                        Textura: Gel<br>
                        Contenido: 5.7 ml
                    </p>
                    <p id="precio" class="text-start mt-lg-2 mt-md-2 pt-sm-2 pt-2">$79.90</p>
                </div>
            </article>
            ...
            <article class="col-lg-3 p-lg-3 pb-lg-0 ms-lg-5 me-lg-5 col-md-5 p-md-3 pb-md-0 ms-md-4 me-md-4 mb-md-5 col-sm-5 p-sm-3 pb-sm-0 ms-sm-4 me-sm-4 mb-sm-5 col-9 p-3 pb-0 ms-5 me-4 mb-5">
                ...
                <div id="demo3" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="imagenes/labial_a1.png" alt="Los Angeles" class="d-block w-100">
                    </div>
                    <div class="carousel-item">
                        <img src="imagenes/labial_a2.png" alt="Chicago" class="d-block w-100">
                    </div>
                    <div class="carousel-item">
                        <img src="imagenes/labial_a3.png" alt="h" class="d-block w-100">
                    </div>
                    </div>
                    <!-- Left and right controls/icons -->
                ...
                <!--Texto-->
                <div id="infor" class="p-lg-2 p-md-2 p-sm-1 p-2">
                    <h6 class="text-start mt-lg-2 mt-md-2 pt-sm-1 pt-2">Labial liquido chocolate</h6>
                    <p class="text-start mt-lg-3 mt-md-3 pt-sm-2 pt-3">
                        Color: Arena<br>
                        Marca: Adara<br>
                        Textura: Mate<br>
                    ...
                    <p id="precio" class="text-start mt-lg-2 mt-md-2 pt-sm-2 pt-2">$90.00</p>
                </div>
            </article>
        </div> 
</section>
